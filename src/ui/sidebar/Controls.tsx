...
import { onNew, onSetHighlight, onChangePainting, clearEvents, onImport } from "../../state/sidebarActions";
...
const doExport = (addToast: any, board: () => string) => {
    ...
    addToast("URL copied to clipboard", { appearance: "info", autoDismiss: true });
};
